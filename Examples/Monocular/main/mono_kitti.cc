...
{   //argv1: ./Vocabulary/ORBvoc.txt
    //argv2: ./Examples/Monocular/yaml_settings/KITTI04-12.yaml
    //argv3: /bluep2/datasets/kitti_odo_gray/sequences/04
